...
namespace BookingEngine.Data.Migrations
{
    ...
    [Migration("20250710083826_ExchangeRate-edit")]
    partial class ExchangeRateedit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookingEngine.Domain.Models.ExchangeRate", b =>
                {
                    b.HasOne("BookingEngine.Domain.Models.Currency", "FromCurrency")
                        .WithMany()
                        .HasForeignKey("FromCurrencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookingEngine.Domain.Models.Currency", "ToCurrency")
                        .WithMany()
