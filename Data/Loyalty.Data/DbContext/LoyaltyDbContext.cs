...
namespace Loyalty.Data.DbContext
{
    public class LoyaltyDbContext : BaseDbContext<LoyaltyDbContext>
    {
        ...
        public DbSet<Domain.Models.SegmentMilesRedemption> SegmentMilesRedemption { get; set; }
        ...
        public DbSet<Domain.Models.TierPricingBundles> TierPricingBundles { get; set; }
