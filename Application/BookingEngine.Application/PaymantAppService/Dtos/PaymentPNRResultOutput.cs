...
namespace BookingEngine.Application.PaymantAppService.Dtos
{
    ...
    public class PaymentPNRResultGetDto 
    {
        ...
        public ICollection<PaymentPNRFlightSegmentGetDto>? Segments { get; set; }
        public ICollection<PaymentPNRPassengerGetDto>? Passengers { get; set; }
        public ICollection<PaymentPNRTaxGetDto>? Taxes { get; set; }
        public ICollection<PaymentPNRFeeGetDto>? Fees { get; set; }
        public ICollection<PaymentPNRETicketInfoGetDto>? ETickets { get; set; }
        public PaymentPNRContactGetDto Contact { get; set; }

    }
    public class PaymentPNRContactGetDto
    {
        public int Id { get; set; }
    ...
    public class PaymentPNRFlightSegmentGetDto
    {
        public int Id { get; set; }
    ...
    public class PaymentPNRPassengerGetDto
    {
        public int Id { get; set; }
    ...
    public class PaymentPNRTaxGetDto
    {
        public int Id { get; set; }
    ...
    public class PaymentPNRFeeGetDto
    {
        public int Id { get; set; }
    ...
    public class PaymentPNRETicketInfoGetDto
    {
        public int Id { get; set; }
